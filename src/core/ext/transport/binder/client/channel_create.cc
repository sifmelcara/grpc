...
// Furthermore, the interface is non-dummy only when
// GRPC_SUPPORT_BINDER_TRANSPORT is true because actual implementation of binder
...
#else  // !GRPC_SUPPORT_BINDER_TRANSPORT
